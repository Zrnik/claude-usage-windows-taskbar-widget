...
- [ ] Časově ukotvené grafy — osa X = reálný čas, mezery kde chybí data
- [ ] Per-key časové okno grafu s defaulty: 5H=2d, 7D=14d, SESSION/100H=14d, REVIEW=7d
- [ ] Settings UI — uživatel může změnit časové okno pro každý klíč
...
- Tech debt: ExtractAccountKey() deduplikace
...
---
*Last updated: 2026-03-11 after v0.2.0 milestone start*
